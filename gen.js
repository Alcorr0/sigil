...
function graphCenter() {
	...
	const centers = [
		...
		// затмение
		[{"type":"Circle","radius":"30","angle A":"0","angle B":"Pi*2","fill":false},{"type":"Width","width":"1","children":[{"type":"Circle","radius":"30","angle A":"0","angle B":"Pi*2","fill":false}]},{"type":"Move","x":"0","y":"100","children":[{"type":"Rotate","angle":"(Time-floor(Time))*1.8-0.9","children":[{"type":"Move","x":"-10*(Time-floor(Time))+5","y":"-100","children":[{"type":"Circle","radius":"30","angle A":"0","angle B":"Pi*2","fill":true}]},{"type":"Move","x":"0","y":"-100","children":[{"type":"Transparent","children":[{"type":"Circle","radius":"30","angle A":"0","angle B":"Pi*2","fill":true}]}]}]}]},{"type":"Transparent","children":[{"type":"Width","width":"70","children":[{"type":"Circle","radius":"65","angle A":"0","angle B":"Pi*2","fill":false}]}]},{"type":"Width","width":"1","children":[{"type":"Radial Circle","radius A":"30","radius B":"50","segments":"16","angle A":"Time*Pi*2+sin(Time*Pi*2+Pi)","angle B":"Pi*2"}]}]
	];
